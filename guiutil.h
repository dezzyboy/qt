...
/** Utility functions used by the GHOST Qt UI.
 */
namespace GUIUtil
{
...
// Render GHOST addresses in moGHOSTpace font
...
// Parse "GHOST:" URI into recipient object, return true on successful parsing
