                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received GHOST from zGHOST"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGHOST"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGHOST));
