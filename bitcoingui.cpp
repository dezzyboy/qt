                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GHOST Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GHOST address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GHOST: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGST"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GHOST Core"), this);
    aboutAction->setStatusTip(tr("Show information about GHOST Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GHOST"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GHOST addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GHOST addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagGHOSTtic information"));
    ...
    openAction->setStatusTip(tr("Open a GHOST: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GHOST Core help message to get a list with possible GHOST command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GHOST Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GHOST network", "", count));
}
...
{
    QString strTitle = tr("GHOST Core"); // default title
...
/** Creates context menu, its actions, and GHOSTs up all the relevant signals for mouse events. */
